...
class NegativeSamplingLoss(nn.Module):
    ...
    def forward(self, input_vectors: torch.Tensor, output_vectors: torch.Tensor,
        ...
        input_vectors = input_vectors.view(input_vectors.shape[0], input_vectors.shape[1], 1)
        output_vectors = output_vectors.view(output_vectors.shape[0], 1, output_vectors.shape[1])
